...
class FactorGraph(object):
    ...
    def add_main_relative_pose(self, pose, covariance):
        """
        ...
        state = self.add_relative_pose(idx - 1, idx, pose, covariance, locked=True, prefix="o")
        if not state:
            print("ERROR")
        self.lock.release()
    ...
    def add_relative_pose(self, from_id, to_id, pose, covariance, locked=False, prefix="s"):
        """
